...
obj_fname = os.path.join(os.path.dirname(__file__), './data/smpl_uv.obj')
...
def render_one_batch(v, f):
    ...
    textures = texture.reshape(1, faces.shape[1], texture_size, texture_size, texture_size, 3).cuda().repeat(
        vertices.shape[0], 1, 1, 1, 1, 1)
